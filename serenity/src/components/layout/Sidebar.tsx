...
const mainNavItems: NavItemType[] = [
  { 
    ...
    icon: FiMapPin,
    children: [
      { name: 'Dashboard', href: '/my-society', icon: FiHome },
      { name: 'Society Directory', href: '/my-society/directory', icon: FiUsers }
    ]
  },
...
const adminNavItems: NavItemType[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Staff Profile Management', href: '/staff/profiles', icon: FiEdit },
...
const platformAdminNavItems: NavItemType[] = [
  ...
  { name: 'User Management', href: '/platform/users', icon: FiUserCheck },
  {
    ...
    children: [
      { name: 'Staff Registration', href: '/staff/registration', icon: FiUserPlus },
      { name: 'Staff Directory', href: '/staff/directory', icon: FiUsers },
      { name: 'Staff Attendance', href: '/staff/attendance', icon: FiClock },
      { name: 'Staff Documents', href: '/staff/documents', icon: FiFileText },
    ]
  },
  {
    name: 'Role Management',
  ...
  return (
    <SidebarContainer>
      ...
      <Navigation>
        ...
        {/* ADMIN Navigation for Admin/Super-Admin */}
        {(userRole === 'admin' || userRole === 'platform-admin') && (
          <NavSection>
            <SectionTitle>Admin</SectionTitle>
            <NavList>
              {renderNavItems(adminNavItems)}
              {renderNavItems(adminNavItems2)}
            </NavList>
          </NavSection>
        )}

        {/* PLATFORM-ADMIN Navigation for Super-Admin only */}
        {userRole === 'platform-admin' && (
          <NavSection>
            <SectionTitle>Platform Admin</SectionTitle>
            <NavList>
              {renderNavItems(platformAdminNavItems)}
            </NavList>
          </NavSection>
        )}
      </Navigation>
